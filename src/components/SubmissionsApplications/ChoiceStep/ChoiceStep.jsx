...
const ChoiceStep = ({
  ...
  const getItemClass = (item) => {
    ...
    if (Array.isArray(activeItem)) {
      if (activeItem.includes(item)) itemClass += " button_option_active";
    } else if (item === activeItem) itemClass += " button_option_active";
  ...
  const handleClickItem = (item) => {
    if (Array.isArray(activeItem)) {
      if (activeItem.includes(item)) {
        setActiveItem(activeItem.filter((currentItem) => currentItem != item));
      } else {
